...
const Filter = ({ showFilter, setShowFilter }) => (
  <div
    ...
    } top-0 transition transform fixed inset-y-0 left-0 z-30 self-start w-64 px-4 mr-4 overflow-y-auto bg-white shadow-sm border-opacity-70 border-r lg:border border-gray-200 whitespace-nowrap lg:rounded lg:translate-x-0 lg:w-auto lg:overflow-visible lg:static lg:block`}
  >
    <div className="absolute top-0 left-0 pt-3 pl-2 lg:hidden">
      <button onClick={() => setShowFilter(false)} className="block text-gray-600 hover:text-gray-800">
    ...
    <div className="text-xl font-medium text-gray-800 mt-12 lg:mt-3">Filter</div>
