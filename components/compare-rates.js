const CompareRates = () => (
  <div className="flex items-center justify-between w-4/5 mx-auto lg:space-x-32 lg:w-9/12">
    <div className="relative w-full space-y-4 lg:space-y-8 lg:w-1/2">
      <div className="text-2xl md:text-3xl font-semibold md:leading-none">
        Compare Rates
        <br />& Save Up to 80 %
      </div>
      ...
      <div className="flex items-center pt-10 lg:justify-between xl:w-4/5">
        <div className="pr-4 sm:pr-8 xl:pr-6 md:w-1/5 lg:w-full">
          <img src="/images/getaroom.png" />
        </div>
        <div className="pr-4 sm:pr-8 xl:pr-6 md:w-1/5 lg:w-full">
          <img src="/images/expedia.png" />
        </div>
    ...
    <div className="hidden w-1/2 lg:block">
      <img className="object-cover w-full rounded h-120" src="/images/beach.jpg" />
    </div>
  </div>
);
